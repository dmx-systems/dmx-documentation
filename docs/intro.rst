...
DMX is licensed under the `GPLv3 <https://www.gnu.org/licenses/gpl.html>`_ or later. Visit `git.dmx.systems <https://git.dmx.systems/explore>` to explore the code.
